        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-8 space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="flex gap-6 items-start p-10 bg-slate-50 border-l-8 border-[#FF1E2D] shadow-xl animate-executive-pulse">
              ...
              <div className="flex gap-6 items-start p-10 bg-[#2B2B2B] text-white shadow-2xl animate-executive-pulse [animation-delay:1s]">
      ...
      <div className="min-h-[60vh] flex flex-col justify-center space-y-16 border-t border-gray-100 pt-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 space-y-12">
            ...
            <div className="p-12 bg-[#2B2B2B] text-center border-b-[12px] border-[#FF1E2D] shadow-2xl animate-executive-pulse">
          ...
          <div className="lg:col-span-5">
            <div className="bg-[#FF1E2D] p-12 shadow-2xl relative overflow-hidden group animate-executive-pulse">
              <div className="absolute top-0 right-0 w-48 h-48 bg-white/10 -mr-24 -mt-24 rotate-45 animate-glow-pulse" />
              ...
              <div className="grid grid-cols-1 gap-8">
                {challenges.map((item, i) => (
                  <div key={i} className="flex items-center gap-6 bg-white/10 p-6 border border-white/5 animate-in fade-in slide-in-from-right-4" style={{ animationDelay: `${i * 200}ms` }}>
