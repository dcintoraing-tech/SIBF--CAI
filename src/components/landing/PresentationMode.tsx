    ...
    <div className="fixed inset-0 z-[100] bg-white flex flex-col overflow-hidden animate-in fade-in duration-500">
      ...
      <div className="absolute top-0 left-0 w-full p-2 md:p-6 flex justify-between items-center z-50 pointer-events-none">
        ...
        <Button 
          ...
          size="icon" 
          onClick={onClose} 
          className="bg-white/80 hover:bg-[#FF1E2D] hover:text-white backdrop-blur-md transition-all w-10 h-10 md:w-16 md:h-16 border border-gray-100 shadow-xl pointer-events-auto group"
        >
          <X className="w-6 h-6 md:w-10 md:h-10 group-hover:rotate-90 transition-transform duration-300" />
        </Button>
      </div>
      ...
      <div className="flex-1 relative bg-white overflow-hidden">
        ...
        >
          <div className="w-full h-full p-4 md:p-8 lg:p-16 flex flex-col justify-center items-center overflow-hidden">
        ...
        <div className="w-full flex justify-between items-center px-4">
          <div className="flex items-center gap-3">
            <Button 
              ...
              className="text-[#2B2B2B] hover:bg-[#FF1E2D] hover:text-white disabled:opacity-20 h-10 md:h-16 px-6 md:px-10 border border-gray-100 font-black uppercase tracking-widest text-[10px] md:text-xs flex gap-3 transition-all shadow-md"
            >
          ...
          <div className="flex-1 text-center hidden md:block px-8">
            <h3 className="text-[#2B2B2B] font-black uppercase tracking-[0.6em] text-[12px] italic truncate">
              {sections[currentSlide].title || "INICIO"}
            </h3>
          </div>

          <div className="text-[10px] md:text-sm font-black text-[#FF1E2D] uppercase tracking-[0.4em] bg-slate-50 px-4 py-2 border border-gray-100 shadow-inner">
